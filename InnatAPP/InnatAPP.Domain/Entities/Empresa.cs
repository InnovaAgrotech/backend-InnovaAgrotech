...
namespace InnatAPP.Domain.Entities
{
    public sealed class Empresa 
    {
        ...
        public Empresa(string nome, string email, string senha, string foto, string bio)
        {
            ValidateDomain(nome, email, senha, foto, bio);
        }

        public Empresa(int id, string nome, string email, string senha, string foto, string bio)
        {
