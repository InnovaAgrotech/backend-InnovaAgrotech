...
namespace InnatAPP.Domain.Tests
{
    public class EnderecoAvaliadorUnitTest
    {
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, null, "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Endereço inválido, o número é obrigatório.");
        }
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "UmDoisTrêsQuatro", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "012345678910", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", null, "Zona Rural", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "", "Zona Rural", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Endereço inválido, a rua é obrigatória.");
        }
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Av", "Zona Rural", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Colheitas Douradas do Cerrado Brasileiro entre os Rios Verde e Araguaia na Região dos Chapadões", "Zona Rural", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", null, "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Endereço inválido, o bairro é obrigatório.");
        }
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zo", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Jardim das Oliveiras na Zona Sul da Cidade com Acesso à Rodovia", "Sinop", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", null, "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Endereço inválido, a cidade é obrigatória.");
        }
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "S", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Santa Rita Costa do Vale Fértil das Terras Agricultáveis Douradas no Sul de Goiás", "MT", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", null, "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Endereço inválido, o estado é obrigatório.");
        }
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "52", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "M", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MTS", "78550000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Endereço inválido, o estado deve ter 2 letras (UF).");
        }
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", null, "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Endereço inválido, o CEP é obrigatório.");
        }
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "SeteOito2Cinco4Zero", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "785500", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "7855000000", "Fazenda verde horizonte, próximo ao posto de combustível");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Endereço inválido, o CEP deve ter 8 dígitos (Sem traço).");
        }
        ...
        {
            Action action = () => new EnderecoAvaliador(1, "1234", "Avenida das Palmeiras", "Zona Rural", "Sinop", "MT", "78550000", "Galpão Agrícola 3, Fundos da Propriedade, próximo ao Silo de Armazenamento, acesso pela Estrada Rural KM 12");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
