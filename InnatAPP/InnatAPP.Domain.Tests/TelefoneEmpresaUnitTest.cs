...
namespace InnatAPP.Domain.Tests
{
    public class TelefoneEmpresaUnitTest
    {
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "16", "987654321", 1);
            action.Should()
        ...
        {
            Action action = () => new TelefoneEmpresa(1, null, "987654321", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "", "987654321", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Número inválido, o DDD é obrigatório.");
        }
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "IG", "987654321", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "1", "987654321", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "165", "987654321", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Número inválido, o DDD deve ter 2 dígitos.");
        }
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "10", "987654321", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "16", null, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "16", "", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Número inválido, o número é obrigatório.");
        }
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "16", "Nove876Cinco432Um", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "16", "9876543", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneEmpresa(1, "16", "9876543210", 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
