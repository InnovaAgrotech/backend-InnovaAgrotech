...
namespace InnatAPP.Domain.Tests
{
    public class ProdutoUnitTest
    {
        ...
        {
            Action action = () => new Produto(1, "Drone AgroScan T-24", "Um drone de modelo simples", 3.6m, "Drone.png", 78, 1, 1);
            action.Should()
        ...
        {
            Action action = () => new Produto(1, null, "Um drone de modelo simples", 3.6m, "Drone.png", 78, 1, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Produto(1, "", "Um drone de modelo simples", 3.6m, "Drone.png", 78, 1, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Nome inválido, o nome é obrigatório.");
        }
        ...
        {
            Action action = () => new Produto(1, "D", "Um drone de modelo simples", 3.6m, "Drone.png", 78, 1, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Produto(1, "AgroScan T-24: Drone Multiespectral com Autonomia de 60 Minutos e Sistema de Pulverização Inteligente.", "Um drone de modelo simples", 3.6m, "Drone.png", 78, 1, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Produto(1, "Drone AgroScan T-24", null, 3.6m, "Drone.png", 78, 1, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new Produto(1, "Drone AgroScan T-24", "", 3.6m, "Drone.png", 78, 1, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Descrição inválida, a descrição é obrigatória.");
        }
        ...
        {
            Action action = () => new Produto(1, "Drone AgroScan T-24", "Um drone", 3.6m, "Drone.png", 78, 1, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        public void CriarProduto_ComAvaliacaoMenorQueZero_ResultandoEmExcecaoDeDominio()
        {
            ...
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Valor de avaliação inválido.");
        }
        ...
        {
            Action action = () => new Produto(1, "Drone AgroScan T-24", "Um drone de modelo simples", 6.2m, "Drone.png", 78, 1, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Valor de avaliação inválido.");
        }
        ...
        {
            Action action = () => new Produto(1, "Drone AgroScan T-24", "Um drone de modelo simples", 3.6m, "drone-profissional-phantom-4-pro-v2-0-com-camera-4k-ultra-hd-estabilizador-gimbal-gps-retorno-automatico-sensor-anticolisao-bateria-longa-duracao-voo-inteligente-autonomo-controle-remoto-7km-transmissao-hd-foto-video-aereo-tecnologia-avancada-xpt123.jpg", 78, 1, 1);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        public void CriarProduto_ComTotalDeReviewsNegativa_ResultandoEmExcecaoDeDominio()
        {
            ...
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Valor total de reviews inválido.");
        }
