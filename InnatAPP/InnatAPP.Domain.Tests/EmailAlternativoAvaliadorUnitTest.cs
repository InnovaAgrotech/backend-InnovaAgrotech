...
namespace InnatAPP.Domain.Tests
{
    public class EmailAlternativoAvaliadorUnitTest
    {
        ...
        {
            Action action = () => new EmailAlternativoAvaliador(1, "EduardaRb@outlook.com");
            action.Should()
        ...
        {
            Action action = () => new EmailAlternativoAvaliador(1, null);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EmailAlternativoAvaliador(1, "");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("E-mail inválido, o e-mail é obrigatório.");
        }
        ...
        {
            Action action = () => new EmailAlternativoAvaliador(1, "E@o");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EmailAlternativoAvaliador(1, "EduardaRboutlook.com");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EmailAlternativoAvaliador(1, "Eduarda Rb@outlook.com");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EmailAlternativoAvaliador(1, "@outlook.com");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EmailAlternativoAvaliador(1, "EduardaRb@");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new EmailAlternativoAvaliador(1, "EduardaRb@outlook");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
