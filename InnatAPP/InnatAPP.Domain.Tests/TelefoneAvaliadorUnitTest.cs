...
namespace InnatAPP.Domain.Tests
{
    public class TelefoneAvaliadorUnitTest
    {
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "16", "987654321");
            action.Should()
        ...
        {
            Action action = () => new TelefoneAvaliador(1, null, "987654321");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "", "987654321");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Número inválido, o DDD é obrigatório.");
        }
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "IG", "987654321");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "1", "987654321");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "165", "987654321");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Número inválido, o DDD deve ter 2 dígitos.");
        }
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "10", "987654321");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "16", null);
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "16", "");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
                .WithMessage("Número inválido, o número é obrigatório.");
        }
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "16", "Nove876Cinco432Um");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "16", "9876543");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () => new TelefoneAvaliador(1, "16", "9876543210");
            action.Should()
                .Throw<InnatAPP.Domain.Validation.DomainExceptionValidation>()
